...
5.  **Roadmapping**: Generating 6-12 month strategic roadmaps in `docs/plan/brainstorming/`.
...
- **Explore Subagent**: Audit existing routes (`docs/cache/API_ROUTES_MAP.md`) before suggesting new ones to avoid redundancy.
