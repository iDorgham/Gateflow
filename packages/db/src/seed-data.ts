...
export function getRandomResortLocation(): string {
  return faker.helpers.arrayElement(RED_SEA_LOCATIONS);
}
...
export function getRandomUtmSource(): string {
  return faker.helpers.arrayElement(UTM_SOURCES);
}
...
export function getRandomUtmCampaign(): string {
  return faker.helpers.arrayElement(UTM_CAMPAIGNS);
}
...
export function getRandomIncidentReason(): string {
  return faker.helpers.arrayElement(INCIDENT_REASONS);
}
...
export function getRandomWatchlistCategory(): string {
  return faker.helpers.arrayElement(WATCHLIST_CATEGORIES);
}
 ...
 */
export function getRandomInternationalName(): {
  firstName: string;
  lastName: string;
  origin: string;
} {
  ...
  const origin = faker.helpers.arrayElement(
    origins
  ) as keyof typeof NAMES_BY_ORIGIN;
  const lexicon = NAMES_BY_ORIGIN[origin];

  const firstName = faker.helpers.arrayElement(lexicon.firstNames);
  const lastName = faker.helpers.arrayElement(lexicon.lastNames);
