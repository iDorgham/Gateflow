 ...
 */
export const ORGANIZATION_FEATURES: Record<OrganizationType, OrganizationFeatures> = {
  [OrganizationType.REAL_ESTATE]: {
    ...
    sidebar: {
      visibleCapabilities: ['overview', 'projects', 'qr', 'scans', 'gates', 'contacts', 'units', 'analytics', 'maintenance', 'team', 'settings'],
      moduleGroups: [
        { id: 'main', labelKey: 'sidebar.groupMain', items: ['overview', 'ai'] },
        { id: 'residents', labelKey: 'sidebar.groupResidents', items: ['contacts', 'units'] },
        { id: 'access', labelKey: 'sidebar.groupAccess', items: ['projects', 'qrcodes', 'scans', 'gates', 'team', 'analytics', 'maintenance'] },
      ],
    },
    dashboard: {
      kpiIds: ['total-scans', 'active-qr', 'active-residents', 'open-maintenance'],
  ...
  [OrganizationType.SCHOOL]: {
    ...
    sidebar: {
      visibleCapabilities: ['overview', 'qr', 'scans', 'gates', 'contacts', 'units', 'analytics', 'team', 'settings'],
      moduleGroups: [
        { id: 'main', labelKey: 'sidebar.groupMain', items: ['overview', 'ai'] },
        { id: 'residents', labelKey: 'sidebar.groupResidents', items: ['contacts', 'units'] },
        { id: 'access', labelKey: 'sidebar.groupAccess', items: ['qrcodes', 'scans', 'gates', 'team', 'analytics'] },
      ],
    },
    dashboard: {
  ...
  [OrganizationType.CLUB]: {
    ...
    dashboard: {
      kpiIds: ['current-capacity', 'total-members', 'active-qr', 'daily-guests'],
  ...
  [OrganizationType.NIGHTCLUB]: {
    ...
    dashboard: {
      kpiIds: ['current-capacity', 'guest-list-count', 'vip-arrivals', 'total-scans'],
  ...
  [OrganizationType.EVENT_ORGANISER]: {
    ...
    sidebar: {
      visibleCapabilities: ['overview', 'projects', 'qr', 'scans', 'gates', 'contacts', 'analytics', 'team', 'settings'],
      moduleGroups: [
        { id: 'main', labelKey: 'sidebar.groupMain', items: ['overview', 'ai'] },
        { id: 'access', labelKey: 'sidebar.groupAccess', items: ['projects', 'qrcodes', 'scans', 'gates', 'team', 'analytics'] },
      ],
    },
    dashboard: {
...
export function getOrganizationFeatures(type: OrganizationType): OrganizationFeatures {
  return ORGANIZATION_FEATURES[type] || ORGANIZATION_FEATURES[OrganizationType.REAL_ESTATE];
}
