...
**Slug:** `design_system`  
**Canonical initiative context:** `docs/plan/context/IDEA_atlassian_ui_remake.md` (evolved into a **multi-reference** system below).  
**Related docs:** `docs/guides/UI_COMPONENT_LIBRARY.md`, `docs/arch/PROJECT_STRUCTURE.md`, `docs/archive/legacy/PRD_v7.0.md` (historical product framing).  
...
**Status:** Planning complete — execute with `/dev design_system <phase>` (1–10 in order) or `/ship design_system` after moving this folder per `docs/plan/PLAN_LIFECYCLE.md` if you use `planned/` / `in-progress/` conventions.
...
`docs/plan/execution/PROMPT_design_system_phase_1.md` … **`PROMPT_design_system_phase_10.md`**
...
- Update `docs/plan/backlog/ALL_TASKS_BACKLOG.md` (and `TASKS_gateflow_design_system.md` if used).
