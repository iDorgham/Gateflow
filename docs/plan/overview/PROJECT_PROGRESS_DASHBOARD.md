...
**Core Documentation:**
- ✅ [PRD_v5.0.md](../phase-1-mvp/specs/PRD_v5.0.md) — Product requirements (5 apps strategy)
- ✅ [MVP_DONE_CHECKLIST.md](./MVP_DONE_CHECKLIST.md) — MVP completion tracking
- ✅ CLAUDE.md — AI assistant guide (Root)
- ✅ [PROJECT_STRUCTURE.md](../architecture/PROJECT_STRUCTURE.md) — Architecture reference
- ✅ [DEVELOPMENT_GUIDE.md](./DEVELOPMENT_GUIDE.md) — Local setup & CLI
- ✅ [SECURITY_OVERVIEW.md](../operations/SECURITY_OVERVIEW.md) — Security architecture
- ✅ [ENVIRONMENT_VARIABLES.md](../operations/ENVIRONMENT_VARIABLES.md) — All env vars
- ✅ [DEPLOYMENT_GUIDE.md](../operations/DEPLOYMENT_GUIDE.md) — Deployment instructions

**Specialized Documentation:**
- ✅ [RESIDENT_PORTAL_SPEC.md](../phase-2-resident-portal/specs/RESIDENT_PORTAL_SPEC.md) — Resident portal spec
- ✅ [DESIGN_TOKENS.md](../architecture/DESIGN_TOKENS.md) — Design system
- ✅ [UI_COMPONENT_LIBRARY.md](../architecture/UI_COMPONENT_LIBRARY.md) — Component docs
- ✅ [PHASE_2_ROADMAP.md](../phase-2-resident-portal/specs/PHASE_2_ROADMAP.md) — Phase 2 features
- ✅ [APP_DESIGN_DOCS.md](../architecture/APP_DESIGN_DOCS.md) — Application design
- ✅ [CODE_QUALITY_AND_PERFORMANCE_AUDIT.md](../phase-1-mvp/specs/CODE_QUALITY_AND_PERFORMANCE_AUDIT.md)
- ✅ [MVP_CODE_QUALITY_AND_SECURITY_REVIEW.md](../phase-1-mvp/specs/MVP_CODE_QUALITY_AND_SECURITY_REVIEW.md)
- ✅ [SECURITY_PERFORMANCE_AUDIT.md](../operations/SECURITY_PERFORMANCE_AUDIT.md)
- ✅ [IMPROVEMENTS_AND_ROADMAP.md](../backlog/IMPROVEMENTS_AND_ROADMAP.md)
- ✅ [Marketing_prompt.md](../phase-3-marketing-ai/specs/Marketing_prompt.md)
...
- 📄 [Marketing & WhatsApp PRD](../phase-3-marketing-ai/specs/PRD_WHATSAPP_MARKETING_EDITION.md)
- 📄 [All Tasks Backlog](../backlog/ALL_TASKS_BACKLOG.md)
- 📄 [Product Requirements Document](../phase-1-mvp/specs/PRD_v5.0.md)

### Key Contacts
- Product questions: Refer to [PRD_v5.0.md](../phase-1-mvp/specs/PRD_v5.0.md)
- Technical questions: Refer to [PROJECT_STRUCTURE.md](../architecture/PROJECT_STRUCTURE.md)
- Security questions: Refer to [SECURITY_OVERVIEW.md](../operations/SECURITY_OVERVIEW.md)
