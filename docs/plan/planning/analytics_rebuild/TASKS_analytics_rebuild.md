...
- [ ] **2.1** Visits-over-time API (time series by day/hour)
- [ ] **2.2** Unit types ranking, top gates, scan outcome, peak days, top units APIs (or extend summary)
- [ ] **2.3** Incidents by gate/operator; resident quota stub if needed
- [ ] **2.4** Shared analytics response types; requireAuth, org scope, filters
- [ ] **2.5** Lint, typecheck, tests pass
