...
> **Context:** `docs/development/initiatives/IDEA_atlassian_ui_remake.md`, `docs/guides/UI_COMPONENT_LIBRARY.md`
...
**Also apply:** `PLAN_gateflow_design_system.md` (plan folder root) → **Production skills** → phase **1** groups.
...
6. `docs/reference/architecture/PROJECT_STRUCTURE.md` — package conventions
