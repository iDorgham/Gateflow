...
- [ ] Interactive perimeter map and terminal cards render live data from `/api/shifts/live`.
- [ ] View toggle switches smoothly between Map and Grid views.
- [ ] ADS tokens and dark mode tested.
- [ ] Arab RTL layout verified.
