...
- [ ] Emergency shift handover action functions properly with audit logging.
- [ ] Warning banners display when gates are unmanned or shifts overrun.
- [ ] `pnpm preflight` green on entire monorepo.
- [ ] `CHANGELOG.md` verified via `pnpm docs:changelog:check`.
