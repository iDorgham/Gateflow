...
- **Active Plan**: `docs/plan/Active/guard_shift_visual_map/PLAN_guard_shift_visual_map.md`
...
- **Plan Lifecycle**: Ready to move to `docs/plan/Complete/guard_shift_visual_map/`.
