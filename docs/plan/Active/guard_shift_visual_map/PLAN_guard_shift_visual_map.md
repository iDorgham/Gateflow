...
| --- | ------------------------------------------------------------------- | ------------ | --------------- | ------ |
| 1   | Live Shift & Gate Telemetry API (API & Security)                    | SECURITY     | claude / cursor | [ ]    |
| 2   | Guard Shift Visual Map & Interactive Grid UI (Frontend)             | FRONTEND     | cursor / gemini | [ ]    |
| 3   | Shift Handover Drawer, Real-Time Alerts & Documentation (QA/DevOps) | QA           | cursor / gemini | [ ]    |
