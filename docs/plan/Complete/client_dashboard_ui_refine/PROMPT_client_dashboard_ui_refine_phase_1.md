...
**FRONTEND** — Use gf-design-guide and tokens-design context. From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `docs/development/initiatives/IDEA_client_dashboard_ui_refine.md`, `docs/guides/UI_DESIGN_GUIDE.md`, `apps/client-dashboard/src/app/globals.css`
