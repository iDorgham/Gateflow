...
- **Baseline**: `docs/guides/performance/baseline_psi.json`
- **Analysis**: `docs/guides/performance/ANALYSIS_performance_killers.md`
...
- **Deliverables**:
  ...
  - [x] Performance baseline documented (`docs/guides/performance/baseline_psi.json`).
...
- **Deliverables**:
  ...
  - [x] `docs/guides/performance/REGRESSION_TESTING_GUIDE.md` — complete runbook for local + CI + production certification.
  - [x] `docs/development/learning/pagespeed_results.md` — phase-by-phase results tracker.
  ...
  - [x] Update `docs/guides/performance/baseline_psi.json` with certified scores.
