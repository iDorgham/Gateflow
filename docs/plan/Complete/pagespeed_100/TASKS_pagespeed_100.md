...
- [x] `docs/guides/performance/baseline_psi.json` — baseline scores + bottlenecks documented
- [x] `docs/guides/performance/ANALYSIS_performance_killers.md` — Top 5 LCP/CLS killers with root causes and fix strategy
...
- [x] Create `docs/guides/performance/REGRESSION_TESTING_GUIDE.md` — complete runbook (local + CI + post-deploy)
- [x] Create `docs/development/learning/pagespeed_results.md` — phase-by-phase results tracker
...
- [ ] Update `docs/guides/performance/baseline_psi.json` with live certified scores
