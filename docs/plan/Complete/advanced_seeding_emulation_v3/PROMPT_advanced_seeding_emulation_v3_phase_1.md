...
**Reference:** `docs/reference/architecture/ARCHITECTURE.md`, `docs/reference/architecture/PROJECT_STRUCTURE.md`, `docs/archive/old-prds/PRD_v8.0.md`, `docs/guides/PROMPTS_REFERENCE.md`

**Seeding detail:** `docs/development/initiatives/IDEA_advanced_seeding_emulation_v3.md` (and `Pasted_Text_1774974939864.txt` if present in repo root or `docs/`).
