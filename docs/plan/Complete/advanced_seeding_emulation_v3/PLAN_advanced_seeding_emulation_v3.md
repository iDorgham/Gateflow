...
**IDEA:** `docs/development/initiatives/IDEA_advanced_seeding_emulation_v3.md`  
**Created:** 2026-03-31  
**Planning workflow:** `docs/development/guidelines/PHASED_DEVELOPMENT_WORKFLOW.md`  
**Subagent roles:** `docs/archive/legacy-plans/guidelines/SUBAGENT_HIERARCHY.md` (canonical copy if `docs/development/guidelines/` is synced from ops-core)
...
| Project structure         | `docs/reference/architecture/PROJECT_STRUCTURE.md` |                                                                               |
...
2. For each phase N: run `/dev` with `docs/plan/Complete/advanced_seeding_emulation_v3/PROMPT_advanced_seeding_emulation_v3_phase_N.md`.
...
All prompts live in **`docs/plan/Complete/advanced_seeding_emulation_v3/`** alongside this file.
