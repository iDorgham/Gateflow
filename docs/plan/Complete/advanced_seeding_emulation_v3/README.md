...
- **Plan file:** `./PLAN_advanced_seeding_emulation_v3.md` (also `docs/plan/Complete/advanced_seeding_emulation_v3/PLAN_advanced_seeding_emulation_v3.md`)
- **Checklist:** `./SCHEMA_TO_SEEDER_CONTRACT_CHECKLIST.md`
- **IDEA source:** `docs/development/initiatives/IDEA_advanced_seeding_emulation_v3.md`
