...
**Also apply:** `PLAN_gateflow_design_system.md` (plan folder root) → **Production skills** → phase **9** groups.
...
1. `.cursor/skills/i18n/SKILL.md`, `.cursor/skills/ads-arabic-egypt-uae-design/SKILL.md`, `.cursor/skills/ads-accessibility-rtl/SKILL.md` — RTL, locale switching, MENA copy/layout notes
2. `.cursor/skills/design-guide/SKILL.md`, `.cursor/skills/responsive-design/SKILL.md` — audit mirrored layouts after `dir` flip
3. `.cursor/skills/creative-animation/SKILL.md` — ensure global motion prefs still respected in localized shell
4. `.cursor/skills/vercel/SKILL.md` — Vercel deploy, regions, headers
5. `.cursor/skills/seo-core/SKILL.md` — docs metadata / OG
...
4. Write `apps/design-system/README.md` deployment section; optional long-form ops note under `docs/guides/` (e.g. next to `DEPLOYMENT_GUIDE.md`) if the repo prefers a dedicated design-system doc.
