...
3. Open `docs/development/learning/patterns.md`. Append 5+ new patterns (use today's session as source).
4. Open `docs/development/learning/decisions.md`. Append 3+ recent decisions.
