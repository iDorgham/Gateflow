...
- [x] **Phase 1: Baseline Audit & README Update**
  ...
  - [x] `docs/PRD.md` scanned — one historical v5 ref at line 735 (correct, not stale)
...
- [x] **Phase 3: Plan Folder Cleanup & Alignment**
  ...
  - [x] 11 workflow files moved to `docs/development/plan-guides/` (ONE*MAN*\*.md, PLAN_LIFECYCLE, PLANNING_ENHANCEMENTS, VIBE_CODER_WORKFLOW, MAN_WORKFLOW)
