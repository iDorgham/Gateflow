...
3. **Draft Rotation Guide**: Create `docs/guides/security/SECRET_ROTATION_GUIDE.md` defining how to rotate the 5 most critical secrets (DB, Vercel, NextAuth, QR, Stripe).
...
- [ ] `docs/guides/security/SECRET_ROTATION_GUIDE.md` exists with clear steps.
