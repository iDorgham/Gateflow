...
- `docs/guides/security/GITHUB_SECURITY_HARDENING_REPORT.md`.
...
4. Generate the final certification report in `docs/guides/security/GITHUB_SECURITY_HARDENING_REPORT.md` summarising all 5 phases.
