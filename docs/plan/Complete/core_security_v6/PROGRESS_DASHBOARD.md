...
| Purpose                   | File                                                                     |
| ------------------------- | ------------------------------------------------------------------------ |
| Full plan (phases, scope) | `docs/plan/Complete/core_security_v6/PLAN_core_security_v6.md`           |
| Phase task checklist      | `docs/plan/Complete/TASKS_core_security_v6.md`                           |
| Phase 4 prompt            | `docs/plan/Complete/core_security_v6/PROMPT_core_security_v6_phase_4.md` |
| Phase 5 prompt            | `docs/plan/Complete/core_security_v6/PROMPT_core_security_v6_phase_5.md` |
| Phase 6 prompt            | `docs/plan/Complete/core_security_v6/PROMPT_core_security_v6_phase_6.md` |
| Automation (run all)      | `.cursor/commands-ref/automate.md`                                       |
| Dev workflow              | `docs/development/guidelines/DEVELOPMENT_WORKFLOWS.md`                   |
