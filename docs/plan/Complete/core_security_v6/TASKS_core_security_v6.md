...
**Plan:** `docs/plan/Complete/core_security_v6/PLAN_core_security_v6.md`  
**Prompts:** `docs/plan/Complete/core_security_v6/PROMPT_core_security_v6_phase_N.md`  
...
- [x] **3.1** Design draft: `docs/guides/design/draft-gate-assignment-screen.md`
