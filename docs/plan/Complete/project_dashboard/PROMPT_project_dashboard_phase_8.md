...
**BACKEND-Database** (schema, migration) + **FRONTEND** (UI). From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `docs/development/initiatives/IDEA_project_dashboard.md`, `.cursor/skills/gf-database/SKILL.md`
