...
**BACKEND-Database** — Prisma queries, aggregates, multi-tenant scoping. From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `packages/db/prisma/schema.prisma`, `docs/development/initiatives/IDEA_project_dashboard.md`
