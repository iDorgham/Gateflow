...
**FRONTEND** — Use gf-design-guide, gf-api. From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `docs/development/initiatives/IDEA_project_dashboard.md`, `docs/plan/Complete/project_dashboard/PLAN_project_dashboard.md`, `apps/client-dashboard/src/components/dashboard/EditPanel.tsx`
