...
**FRONTEND** — Use gf-design-guide and gf-creative-ui-animation context. From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `docs/development/initiatives/IDEA_real_estate_palette.md`, `docs/guides/MOTION_AND_ANIMATION.md`, `packages/ui/src/components/auth/login-shell.tsx`, `packages/ui/src/components/auth/login-particles.tsx`
