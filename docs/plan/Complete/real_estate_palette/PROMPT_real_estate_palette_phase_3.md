...
**FRONTEND** — Use gf-design-guide context. From `docs/development/guidelines/SUBAGENT_HIERARCHY.md`.
...
- **Refs**: `docs/development/initiatives/IDEA_real_estate_palette.md`, `docs/guides/UI_DESIGN_GUIDE.md`
