...
**Plan:** `docs/plan/Complete/residents_analytics/PLAN_residents_analytics.md`  
**Prompts:** `docs/plan/Complete/residents_analytics/PROMPT_residents_analytics_phase_N.md`
