...
- **Refs**: `CLAUDE.md`, `docs/plan/Draft/analytics_rebuild/PLAN_analytics_rebuild.md`, `docs/development/initiatives/IDEA_analytics_rebuild.md`, `packages/ui/src/tokens.ts`, `apps/client-dashboard/src/app/globals.css`
