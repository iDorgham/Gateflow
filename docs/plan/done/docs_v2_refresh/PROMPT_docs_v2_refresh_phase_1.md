...
- **Refs**:
  ...
  - `docs/PRD_v7.0.md` — canonical PRD (exists)
...
- **Validate PRD**: Open `docs/PRD_v7.0.md` and confirm it does not reference a v5 PRD as "current" or contain unresolved TODOs that would mislead a new reader.
...
4. Open `docs/PRD_v7.0.md`, scan first 50 and last 50 lines for any unresolved TODOs or v5 cross-references. Note any found — no changes required if clean.
