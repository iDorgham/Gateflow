...
- Reads core context:
  - `CLAUDE.md`
  - `docs/development/initiatives/README.md`
...
- Writes/updates:
  - `docs/development/initiatives/IDEA_<slug>.md` for this initiative
...
- Treat `docs/development/initiatives/IDEA_<slug>.md` and `docs/plan/backlog/ALL_TASKS_BACKLOG.md` as the **only** persistence layer for ideas/backlog.
...
5. **When the user says the idea is "good enough"**
   - Create `docs/development/initiatives/IDEA_<name>.md` with:
...
3. Save or update `IDEA_<slug>.md` under `docs/development/initiatives/`.
