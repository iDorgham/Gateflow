...
| 2026-08-30 | **Resident Mobile One-Tap Biometric & Instant Pass Experience** | ✅ Shipped | Biometric unlock in $\le 800\text{ms}$, fail-closed PIN fallback, HMAC-SHA256 vector QR, 3-tap visitor sharing, interactive arrival alerts ($\le 3\text{s}$), and local encrypted audit ledger. |
