...
3. **Reports**
   ...
   - **Design mode** — When UI/UX/design/animation intent is detected: include design brief, recommend gf-design-guide, gf-creative-ui-animation, SuperDesign, and motion checklist.
