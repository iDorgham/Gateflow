...
- **Description:** Keep one canonical PRD (`docs/PRD.md`) and archive older versions/specs under `docs/archive/**`. Only ever update the canonical spec going forward.
