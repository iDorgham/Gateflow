...
- **Decision:** Move all legacy `docs/plan/**` content to `docs/archive/plan-legacy/**` and keep `docs/PRD.md` as the single canonical PRD at the root.
- **Alternatives considered:**
  - Keep `PRD.md` under `docs/plan/phase-1-mvp/specs/`.
...
### Use docs/development/learning as shared knowledge base
