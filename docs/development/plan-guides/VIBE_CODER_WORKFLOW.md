...
**Goal:** Keep the fun of vibe coding, add structure only when it helps — so you build _viable_ code without ceremony overload.
...
- **Requirements-First** — Start with behavior → requirements (EARS) → design → tasks. Best when you know _what_ you want.
- **Design-First** — Start with architecture → derive requirements → tasks. Best when you know _how_ it should work.
...
When you know _what_ the system should do:
...
When you know _how_ it should work:
