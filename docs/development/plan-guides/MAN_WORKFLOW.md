...
**One Man Code** is the method name for the `/man` master orchestrator. Full spec: **`docs/development/plan-guides/ONE_MAN_CODE.md`** (subcommands: tasks, settings, run, ship, status; SaaS-specialized).
...
- `docs/development/plan-guides/PLANNING_ENHANCEMENTS.md` — BMad/Kiro remix
