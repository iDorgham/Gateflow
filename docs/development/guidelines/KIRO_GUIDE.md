...
| `/dev`    | Execute a single phase prompt from `docs/plan/Active/` or `Ready/` (`phases/NN_*/PROMPT_phase_NN.md`) |
...
Save each phase as `docs/plan/Draft/<slug>/phases/NN_<title>/PROMPT_phase_NN.md` (archived plans under `Complete/<slug>/` may still use flat `PROMPT_*_phase_*.md`).
...
| `docs/development/guidelines/TEMPLATE_API_route.md`               | API route template      |
| `docs/development/guidelines/TEMPLATE_API_test.md`                | Test template           |
| `docs/development/guidelines/subagents/`                          | Subagent prompt library |
