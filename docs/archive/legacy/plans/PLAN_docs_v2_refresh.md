...
- Make `docs/PRD.md` the **single canonical PRD**.
...
- Confirm `docs/PRD.md` content matches archived `docs/archive/plan-legacy/phase-1-mvp/specs/PRD.md`.
...
- [ ] Validate that `docs/PRD.md` is complete and consistent (no TODOs or dangling references to v5 as “current”).
...
- [ ] Add or update a very small `docs/README.md` that:
  - Points to `PRD.md` as the canonical spec.
  - Briefly explains that legacy docs are under `docs/archive/**`.

**Acceptance criteria:**

- There is **exactly one** canonical PRD file referenced as current: `docs/PRD.md`.
...
- Use `PRD.md`, `CLAUDE.md`, `GATEFLOW_CONFIG.md`, and relevant archived docs as input only.
...
- All four guides exist, pass basic lint/format checks, and are internally consistent with `PRD.md`.
