...
**Goal:** Visual polish (consistent design tokens, dark mode, spacing), add `typecheck` script, basic tests for all API routes and key components, update `docs/PRD.md` admin dashboard status.
...
- `docs/PRD.md` — update admin dashboard completion %
