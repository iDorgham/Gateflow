...
The GateFlow team uses multiple AI-assisted tools. See `docs/plan/guidelines/DEVELOPMENT_TOOLS.md` for the full reference.
...
All tools should follow the same repo rules (pnpm, multi-tenancy, QR security, no secrets in git). See `CLAUDE.md` and `docs/plan/guidelines/AI_SKILLS_SUBAGENTS_RULES.md`.
