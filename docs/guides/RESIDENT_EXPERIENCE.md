...
**Version:** 1.0
**Aligned with:** `docs/PRD.md` (Resident Portal & Mobile, Resident Mobile Enhancement Plan)
...
Implementation details live in the apps (`resident-portal`, `resident-mobile`) and backend APIs, but this guide should stay aligned with `PRD.md` as the product evolves.
