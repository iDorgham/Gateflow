...
Implementation details live in the apps (`resident-portal`, `resident-mobile`) and backend APIs, but this guide should stay aligned with `PRD_v6.0.md` as the product evolves.
