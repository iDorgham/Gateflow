...
**Version:** 1.0  
**Aligned with:** `docs/PRD.md` (Scanner App, Scanner Rules, Visitor Identity, Watchlists)
...
This guide should be kept in sync with `PRD.md` as scanner features evolve.
