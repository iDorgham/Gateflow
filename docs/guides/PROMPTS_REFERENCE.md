...
**Outputs**
1. **Plan:** `docs/plan/Complete/PLAN_core_security_v6.md`
...
| File | Description |
|------|--------------|
| `docs/plan/Complete/PLAN_core_security_v6.md` | Six-phase plan: invariants → gate–account (model+API) → gate–account (UI) → location rule → watchlists/incidents → identity & retention |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_1.md` | Core invariants & enforcement hardening (SECURITY) |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_2.md` | Gate–account assignment: model + API + enforcement (SECURITY) |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_3.md` | Gate–account: dashboard UI + scanner UX (FRONTEND / MOBILE) |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_4.md` | Location rule optional (SECURITY) |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_5.md` | Watchlists, incidents & guard accountability (SECURITY) |
| `docs/plan/Complete/PROMPT_core_security_v6_phase_6.md` | Visitor identity levels & privacy/retention (SECURITY / MOBILE) |
...
3. Confirm which plan is active (e.g. core_security_v6) and which phase is next from `docs/plan/Complete/PLAN_core_security_v6.md` (or the plan the user cares about).
...
2. Load the phase prompt: `docs/plan/Complete/PROMPT_<slug>_phase_<N>.md` (e.g. PROMPT_core_security_v6_phase_1.md).
...
**Request:** Execute phase 1 of core_security_v6. Use `docs/plan/Complete/PROMPT_core_security_v6_phase_1.md` as the single source of truth.
