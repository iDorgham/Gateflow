...
Record results in `docs/development/learning/pagespeed_results.md`.
...
# 5. Update docs/development/learning/pagespeed_results.md with certified scores
# 6. Update docs/guides/performance/baseline_psi.json with certified scores
