...
# 1) Factory commands are scoped under `.ai/commands/factory/`.

# 2) They do NOT overwrite GateFlow canonical commands in `.cursor/commands/` or `.antigravity/workflows/`.
...
_Merged from the former `commands_multi_tool.md` — single canonical doc is **`commands.md`**._
...
_Multi-tool rankings version: 1.0 · Owner: guide-agent · Merged into `commands.md` 2026-05-01_
