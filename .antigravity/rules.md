...
This repo’s canonical AI context lives in `.antigravity/` (mirrored from `.antigravity/`).
...
- **Workflows**: Located in `.antigravity/workflows/`. Use for automation (`/guide`, `/dev`, `/plan`).
