...
**Template:** `.antigravity/templates/TEMPLATE_API_route.md` for full scaffold (GET/POST with auth, Zod, org scope).
**Contracts:** `.antigravity/contracts/CONTRACTS.md` — invariants.
