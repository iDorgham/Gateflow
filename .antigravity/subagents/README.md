...
**Extended library:** `.antigravity/templates/subagents/` — More prompts for explore, shell, browser-use (flows, security, i18n, etc.)

**Full reference:** `docs/development/guidelines/AI_SKILLS_SUBAGENTS_RULES.md`, `docs/development/guidelines/SUBAGENT_HIERARCHY.md`
