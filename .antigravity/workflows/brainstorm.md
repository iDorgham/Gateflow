...
1.  **Context Loading**: Reads `CLAUDE.md`, `docs/PRD_v7.0.md`, `docs/plan/backlog/ALL_TASKS_BACKLOG.md`, and `docs/reference/cache/API_ROUTES_MAP.md`.
...
4.  **Capture structured results**:
    - Save to `docs/development/brainstorming/STRATEGY_<topic>_<slug>.md`.
