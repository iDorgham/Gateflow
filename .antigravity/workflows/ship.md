...
- Ensures plan artifacts exist:
  - Resolves plan location per `docs/plan/PLAN_LIFECYCLE.md` (in-progress/, planned/, planning/, execution/).
...
- Execute every phase in `PLAN_<slug>.md` (from resolved location: in-progress/, planned/, or execution/) sequentially.
