...
**No arg (`/man mindset`):**
1. List available profiles (from `docs/plan/learning/ONE_MAN_PROFILES.md` or the seven: code, brand, saas, marketing, business, content, copywrite).
2. Show current profile (from `docs/plan/learning/ONE_MAN_MEMORY.md` currentDomain/currentProfile/currentMindset).
