...
This contract is enforced together with `.kilocode/rules/00-gateflow-core.mdc`, `.kilocode/rules/gateflow-security.mdc`, and `.kilocode/skills/gf-security/SKILL.md`.
...
- The implementing agent must:
  - Load `.kilocode/skills/gf-security/SKILL.md` and `.kilocode/contracts/CONTRACTS.md` before making changes.
...
- Ignore or override SECURITY contracts in this file, `.kilocode/rules/00-gateflow-core.mdc`, or `.kilocode/rules/gateflow-security.mdc`
