...
**Shared context:** All tools should have access to `CLAUDE.md`, `docs/`, `.antigravity/rules/`. Point prompts at these or run from repo root.
...
See `.antigravity/skills/gf-planner/SKILL.md` for pro prompt template with multi-CLI section.
...
- `.antigravity/skills/gf-planner/SKILL.md` — Phased planning with subagents and Multi-CLI integration
