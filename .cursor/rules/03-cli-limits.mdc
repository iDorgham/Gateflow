...
**Load** `.antigravity/skills/gf-cli-limits/SKILL.md` when suggesting or choosing a CLI. This rule applies to `/dev`, `/guide`, and any phase or command that can invoke an external CLI.
