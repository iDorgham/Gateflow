...
- When a pattern repeats (e.g. same tool+task type wins several times), update `docs/plan/learning/CLI_TOOL_MEMORY.md` with a short note, or invoke `.antigravity/skills/gf-cli-memory/SKILL.md` for a structured update.
