...
import { ArrowLeft, History, User, CheckCircle2, XCircle, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-md mx-auto px-4 py-6 space-y-4 pb-12">
        <div className="space-y-3">
          {scans.length > 0 ? (
            scans.map((scan) => (
              <div key={scan.id} className="bg-white rounded-xl p-4 shadow-sm border border-slate-200 flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-600">
                    Entered through <span className="font-medium text-slate-900">{scan.gate.name}</span>
                  </p>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-400 text-sm mt-1">Logs will appear here once visitors scan their QR codes.</p>
            </div>
          )}
        </div>
      </main>
