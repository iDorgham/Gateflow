    ...
    if (currentScreen === 'home') {
      return (
        <HomeScreen
          ...
          onVisitorPress={(v: any) =>
            navigateTo('visitor_detail', { visitor: v })
          }
        />
      );
    }
        ...
        {quota && (
          <View style={styles.card}>
            ...
            <Text style={styles.quotaSubtext}>
              {quota.remaining} visitors remaining
            </Text>
          </View>
        )}
        ...
        <View style={styles.listCard}>
          ...
          {visitors.slice(0, 5).map((v: any) => (
            ...
            >
              ...
              <View
                style={[styles.statusBadge, v.isOpenQR && styles.purpleBadge]}
              >
                <Text
                  style={[
                    styles.statusBadgeText,
                    v.isOpenQR && styles.purpleText,
                  ]}
                >
      ...
      <View style={styles.formContainer}>
        ...
        >
          {loading ? (
            ...
            <Text style={styles.submitButtonText}>Generate Open QR</Text>
          )}
        </TouchableOpacity>
      </View>
    </View>
...
function VisitorDetailScreen({ visitor, onBack }: any) {
  const handleShare = async () => {
    ...
    await Sharing.shareAsync(
      `Pass for ${visitor.visitorName || 'Visitor'}: ${visitor.qrCode.code}`
    );
  };
    ...
    <View style={styles.flex1}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.qrCard}>
          <Text style={styles.qrVisitorName}>
            {visitor.visitorName || 'Open Access Pass'}
          </Text>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>
              {visitor.accessRule?.type || 'ONETIME'}
            </Text>
          </View>
        </View>
      </ScrollView>
