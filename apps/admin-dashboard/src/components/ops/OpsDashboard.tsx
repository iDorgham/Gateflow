...
const LEAD_FUNNEL_DATA = [
  ...
  { name: 'Contacted', value: 1800, fill: 'var(--ds-background-brand-subtle)' },
  {
    name: 'Qualified',
    value: 1200,
    fill: 'var(--ds-background-brand-bold-muted, var(--ds-background-neutral-hovered))',
  },
  {
    name: 'Negot.',
    value: 800,
    fill: 'var(--ds-background-brand-bold-subtle, var(--ds-background-brand-subtle))',
  },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          },
          {
            ...
            growth: '+5%',
            icon: Users,
            color: 'text-ds-text-information',
          },
          {
            label: 'AI Efficiency',
            value: '84%',
          ...
          <Card
            key={i}
            className="border-ds-border bg-ds-background-default shadow-sm hover:shadow-md transition-shadow"
          >
              ...
              <div className="flex justify-between items-start">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-[10px] text-ds-text-subtle uppercase font-bold tracking-tighter">
                      vs last month
                    </span>
                  </div>
                </div>
                <div
                  className={cn(
                    'p-2 rounded-xl bg-ds-background-neutral-subtle',
                    stat.color
                  )}
                >
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-ds-text-subtle font-bold uppercase tracking-widest">
                  Across Gemini & GPT Models
                </p>
              </div>
              <Button
                variant="outline"
              ...
              <AreaChart data={AI_COST_DATA}>
                <defs>
                  ...
                  >
                    <stop
                      offset="5%"
                      stopColor="var(--ds-background-information-bold)"
                      stopOpacity={0.1}
                    />
                    <stop
                      offset="95%"
                ...
                <Area
                  type="monotone"
                  dataKey="Marketing"
                  stroke="var(--ds-background-information-bold)"
                  strokeWidth={3}
                  fillOpacity={1}
                ...
                <Area
                  type="monotone"
                  dataKey="Dev"
                  stroke="var(--ds-background-brand-subtle)"
                  strokeWidth={2}
                  fill="transparent"
                />
              </AreaChart>
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            <div className="flex-1 space-y-4 text-center lg:text-left">
              ...
              <p className="text-sm text-ds-text-subtle max-w-2xl leading-relaxed">
                &quot;Sales performance is up by 12% following the Phase 5
                Landing Page roll-out. AI costs peaked on Wednesday during the
                high-volume blog generation cycle. Recommended action: Optimize
                prompt caching for repeated CMS translation calls to reduce cost
                by ~15%.&quot;
              </p>
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 pt-2">
                <Badge className="bg-ds-background-brand-bold font-black text-[9px] tracking-widest uppercase px-3 py-1">
                  Strategy Confirmed
                </Badge>
                <Badge
                  variant="outline"
                  className="border-ds-border-brand/30 text-ds-text-brand font-black text-[9px] tracking-widest uppercase px-3 py-1"
                >
            ...
            <Button
              size="lg"
              className="bg-ds-background-brand-bold hover:bg-ds-background-brand-bold-hover h-16 px-10 font-black text-[11px] tracking-widest uppercase shadow-xl shadow-ds-background-brand-bold/20"
            >
