      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-ds-text-subtle text-sm">
            Configure agentic rules to automate task generation across your
            organization.
          </p>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-ds-border/40 overflow-hidden">
            <CardHeader className="bg-ds-background-neutral-subtle/30 border-b border-ds-border/20">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-black uppercase tracking-widest text-ds-text-subtle">
                  Active Automation Rules
                </CardTitle>
                <Badge
                  variant="outline"
                  className="font-bold text-[10px] tracking-widest bg-ds-background-default"
                >
              ...
              <Table>
                <TableHeader className="bg-ds-background-neutral-subtle/10">
                  <TableRow className="hover:bg-transparent border-ds-border/20">
                    <TableHead className="text-[9px] font-black uppercase tracking-widest text-ds-text-subtle h-10 px-6">
                      Status
                    </TableHead>
                    <TableHead className="text-[9px] font-black uppercase tracking-widest text-ds-text-subtle h-10">
                      Rule Name & Trigger
                    </TableHead>
                    <TableHead className="text-[9px] font-black uppercase tracking-widest text-ds-text-subtle h-10">
                      Department
                    ...
                    <TableHead className="text-[9px] font-black uppercase tracking-widest text-ds-text-subtle h-10 text-right px-6">
                      Actions
                    </TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {rules.map((rule) => (
                    <TableRow
                      key={rule.id}
                      className="group border-ds-border/20 hover:bg-ds-background-neutral-subtle/20 transition-colors"
                    >
                      ...
                      <TableCell>
                        <Badge
                          variant="outline"
                          className="text-[9px] font-bold tracking-tighter bg-ds-background-neutral-subtle/30 border-none"
                        >
                          {rule.department}
                        </Badge>
                      </TableCell>
                      ...
                      <TableCell className="text-right px-6">
                        <Button
                          size="icon"
                          variant="ghost"
                          className="h-8 w-8 hover:bg-ds-background-default"
                        >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-2">
              ...
              <span className="text-[11px] font-black uppercase tracking-widest text-ds-text-subtle">
                Recent Bot Activity
              </span>
            </div>
            ...
            <div className="space-y-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="flex items-start gap-4 p-4 rounded-2xl bg-ds-background-neutral-subtle/20 border border-ds-border/30"
                >
                  <div
                    className={cn(
                      'mt-1 p-2 rounded-lg',
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-bold">
                        Rule Executed: Lead Scoring Threshold Reached
                      </p>
                    ...
                    <p className="text-xs text-ds-text-subtle">
                      ...
                      <span className="text-ds-text font-medium">
                        Follow up with Al Rimal Development Team
                      </span>
                    </p>
                    <div className="flex items-center gap-3 pt-1">
                      <Badge
                        variant="outline"
                        className="text-[8px] font-black bg-ds-background-default border-none"
                      >
                      ...
                      {i === 3 && (
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-6 px-2 text-[9px] font-black bg-ds-background-brand-subtle text-ds-text-brand"
                          >
                            APPROVE
                          </Button>
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-6 px-2 text-[9px] font-black text-ds-text-subtle"
                          >
                            IGNORE
                          </Button>
                        </div>
          ...
          <Card className="border-ds-border-brand/30 bg-ds-background-brand-subtle/10">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm font-black uppercase tracking-widest text-ds-text-brand">
                  Bot Health Monitor
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <p className="text-[9px] font-black text-ds-text-subtle uppercase tracking-widest">
                    Rate Limit Score
                  </p>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-2xl font-black">
                    4.9<span className="text-xs text-ds-text-subtle">/5</span>
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-ds-text-subtle italic">
                    &quot;Sales follow-up rule&quot; is approaching the hourly
                    rate limit (8/10). No intervention required yet.
                  </p>
                </div>
              </div>
            </CardContent>
