      ...
      <SheetContent className="w-full sm:max-w-[540px] border-l border-ds-border overflow-y-auto">
        <SheetHeader className="pb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <Badge
              variant="outline"
              className="uppercase text-[9px] font-bold tracking-tighter bg-ds-background-neutral-subtle/30"
            >
              {lead.status}
            </Badge>
          </div>
          ...
          <SheetDescription className="text-[10px] uppercase tracking-[0.2em] font-black text-ds-text-subtle">
            {lead.orgType} VERTICAL • CAPTURED{' '}
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4 relative z-10">
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-[10px] font-black uppercase tracking-wider text-ds-text">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="p-4 rounded-xl bg-ds-background-neutral-subtle/30 border border-ds-border/40 text-sm leading-relaxed text-ds-text italic font-medium">
                &quot;
                {lead.notes ??
                  'No specific notes provided with the initial inquiry.'}
                &quot;
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-ds-border/40 flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="h-12 gap-2 font-bold uppercase text-[10px] tracking-widest border-ds-border/60"
              >
              ...
              <Button
                variant="ghost"
                className="h-12 gap-2 font-bold uppercase text-[10px] tracking-widest text-ds-text-subtle"
                onClick={onClose}
              >
                Dismiss
              </Button>
