      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Organization ID</Label>
                    <Input 
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Project ID (Optional)</Label>
                    <Input 
                      value={projectId}
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Phases Range</Label>
                      <Badge variant="subtle" className="font-mono text-[10px]">{minPhases} — {maxPhases}</Badge>
                    </div>
                    <div className="flex gap-6">
                      <Input type="range" min="1" max="16" value={minPhases} onChange={(e) => setMinPhases(parseInt(e.target.value))} className="accent-ds-background-selected" />
                      <Input type="range" min="1" max="16" value={maxPhases} onChange={(e) => setMaxPhases(parseInt(e.target.value))} className="accent-ds-background-selected" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Buildings per Phase</Label>
                      <Badge variant="subtle" className="font-mono text-[10px]">{minBuildings} — {maxBuildings}</Badge>
                    </div>
                    <div className="flex gap-6">
                      <Input type="range" min="1" max="24" value={minBuildings} onChange={(e) => setMinBuildings(parseInt(e.target.value))} className="accent-ds-background-selected" />
                      <Input type="range" min="1" max="24" value={maxBuildings} onChange={(e) => setMaxBuildings(parseInt(e.target.value))} className="accent-ds-background-selected" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Floors per Building</Label>
                      <Badge variant="subtle" className="font-mono text-[10px]">{minFloors} — {maxFloors}</Badge>
                    </div>
                    <div className="flex gap-6">
                      <Input type="range" min="1" max="32" value={minFloors} onChange={(e) => setMinFloors(parseInt(e.target.value))} className="accent-ds-background-selected" />
                      <Input type="range" min="1" max="32" value={maxFloors} onChange={(e) => setMaxFloors(parseInt(e.target.value))} className="accent-ds-background-selected" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-ds-background-neutral-subtle border border-ds-border rounded-xl p-6 space-y-4">
             <h4 className="text-[10px] font-black uppercase tracking-widest text-ds-text-subtle">Seeding Protocol</h4>
             <p className="text-xs text-ds-text-subtle leading-relaxed font-medium">
                Advanced Seeding generates architectural hierarchies (Units) and associated synthetic residents (Contacts). 
             </p>
             <div className="p-4 rounded-lg bg-ds-background-default border border-ds-border-subtle space-y-3">
                <div className="flex items-center gap-3">
                   ...
                   <span className="text-[10px] font-bold text-ds-text uppercase">Deep Relational Chain</span>
                </div>
                <p className="text-[10px] text-ds-text-subtlest pl-4 leading-tight">
                   Creates Projects, Phases, Buildings, Floors, and Units in a secure relational chain.
                </p>
             </div>
