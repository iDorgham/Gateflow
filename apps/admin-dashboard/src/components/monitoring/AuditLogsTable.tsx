    ...
    () => [
      {
        ...
        render: (log) => {
          ...
          return (
            <Badge
              variant={variants[log.status] || 'default'}
              className="h-6 px-2"
            >
              {log.status}
            </Badge>
      ...
      },
      {
        ...
        render: (log) => (
          <div className="flex flex-col gap-1">
            <Badge
              variant="subtle"
              className="text-[9px] h-4 w-fit px-1.5 font-black"
            >
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-1.5 overflow-hidden">
                {trail.slice(0, 3).map((_, i) => (
                  <div
                    key={i}
                    className="h-4 w-4 rounded-full border border-ds-background-default bg-ds-background-neutral flex items-center justify-center shadow-sm"
                  >
        ...
        <div className="flex flex-col items-center justify-center p-20 gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-ds-text-subtle">
              No historical audit logs match your current filter parameters.
            </p>
          </div>
        </div>
      }
