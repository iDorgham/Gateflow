      ...
      <div className="bg-ds-background-default border border-ds-border rounded-xl p-5 shadow-sm space-y-4">
        <form method="GET" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-5 items-end">
          ...
          <div className="flex items-center gap-2">
            <Button type="submit" variant="primary" className="h-9 px-6 font-semibold shadow-none flex-1 rounded-full">
              <Search className="h-3.5 w-3.5 ltr:mr-2 rtl:ml-2" />
              {t('scans.search')}
            </Button>
            <Button variant="subtle" className="h-9 w-9 p-0 rounded-full border-ds-border" asChild>
