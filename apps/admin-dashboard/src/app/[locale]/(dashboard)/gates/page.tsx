            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50 text-muted-foreground text-[10px] font-bold uppercase tracking-widest border-b border-border">
                  <th className="px-6 py-4 text-left rtl:text-right">{t('gates.gate')}</th>
                  <th className="px-6 py-4 text-left rtl:text-right">{t('gates.orgProject')}</th>
                  <th className="px-6 py-4 text-center">{t('gates.scans')}</th>
                  <th className="px-6 py-4 text-center">{t('gates.status')}</th>
                  <th className="px-6 py-4 text-right rtl:text-left">{t('gates.actions')}</th>
                </tr>
              </thead>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1">
                            ...
                            {gate.project ? (
                              ...
                              <p className="text-[10px] text-muted-foreground italic">{t('gates.noProject')}</p>
                            )}
                          </div>
                        </td>
                            ...
                            {deleted ? (
                              ...
                              <>
                                <form action={setGateActive}>
                                  ...
                                  >
                                    {gate.isActive ? t('gates.deactivate') : t('gates.activate')}
                                  </Button>
                                </form>
