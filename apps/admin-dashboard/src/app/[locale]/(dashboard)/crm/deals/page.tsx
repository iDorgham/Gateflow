...
export const metadata = { title: 'Deal Pipeline | Global' };

export default async function GlobalDealsPage(props: {
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 space-y-8 animate-in fade-in duration-700">
      <div className="relative">
        ...
        <div className="relative bg-ds-background-default border-2 border-ds-border p-8 rounded-[2.5rem] shadow-xl">
          <Briefcase className="h-20 w-20 text-ds-text-brand" />
        </div>
      </div>
      ...
      <div className="max-w-md space-y-4">
        <PageHeader
          title="Deal Pipeline"
          subtitle="Real estate deals, pipelines, and revenue tracking are managed within individual organizations."
          className="text-center"
        />
        <p className="text-sm text-ds-text-subtlest font-medium uppercase tracking-widest">
          Select an organization to view and manage active deal pipelines.
        </p>
      </div>
