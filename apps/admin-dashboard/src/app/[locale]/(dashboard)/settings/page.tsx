      ...
      <div className="rounded-xl border border-ds-border-warning/30 bg-ds-background-warning-subtle/10 p-6 flex items-start gap-4">
        ...
        <div className="space-y-2">
          <h4 className="text-xs font-black uppercase tracking-tight">
            Configuration Environment Notice
          </h4>
          <p className="text-[11px] text-ds-text-subtle leading-relaxed max-w-2xl">
            All settings shown are derived from the active environment
            variables. Changes require a server restart or deployment update.
            Local overrides can be managed via your{' '}
            <code className="bg-ds-background-subtle px-1 rounded font-mono">
              .env.local
            </code>{' '}
          ...
          <Button
            variant="outline"
            size="sm"
            className="h-8 text-[9px] font-black uppercase tracking-widest px-4 border-ds-border-warning/30 text-ds-text-warning hover:bg-ds-background-warning-subtle/30"
          >
            Restart Instance
          </Button>
        </div>
