...
import { cn, Card, ScrollArea, PageHeader } from '@gate-access/ui';
...
export default function SettingsLayout({
  ...
  const sidebarItems: SettingsSidebarItem[] = [
    {
      href: `/settings`,
      label: t('admin:settings.nav.overview', 'Overview'),
      icon: Info,
    },
    {
      href: `/settings/database`,
      label: t('admin:settings.nav.database', 'Database'),
      icon: Database,
    },
    {
      href: `/settings/auth`,
      label: t('admin:settings.nav.auth', 'Authentication'),
      icon: ShieldCheck,
    },
    {
      href: `/settings/security`,
      label: t('admin:settings.nav.security', 'Security & QR'),
      icon: Lock,
    },
    {
      href: `/settings/infrastructure`,
      label: t('admin:settings.nav.infra', 'Infrastructure'),
      icon: Globe,
    },
    {
      href: `/settings/compliance`,
      label: t('admin:settings.nav.compliance', 'Compliance'),
      icon: FileText,
    },
  ];
    ...
    <div className="flex flex-col gap-8">
      <PageHeader
        ...
        subtitle={t(
          ...
          'Configure global environment variables, security policies, and infrastructure keys.'
        )}
      />
