        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4 p-4 rounded-xl bg-ds-background-neutral-subtle/20 border border-ds-border/10 mb-8">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-ds-text-subtle font-medium italic">
                &quot;The platform meets all GDPR and Law 151 residency
                requirements as of the last automated audit.&quot;
              </p>
            </div>
            <Badge className="ml-auto bg-ds-background-success-subtle text-ds-text-success border-ds-border-success font-black text-[10px] uppercase">
              Active
            </Badge>
          </div>
        ...
        <CardContent className="p-0">
          <table className="w-full text-left">
            <thead className="bg-ds-background-neutral-subtle/20 border-b border-ds-border/10">
              <tr>
                <th className="p-4 text-[9px] font-black uppercase tracking-widest text-ds-text-subtle">
                  Date
                </th>
                <th className="p-4 text-[9px] font-black uppercase tracking-widest text-ds-text-subtle">
                  Category
            ...
            <tbody>
              {[
                {
                  date: '29/04/2026',
                  cat: 'GDPR Data Portability',
                  status: 'Passed',
                },
                {
                  date: '15/04/2026',
                  cat: 'SOC2 Type I Control',
                  status: 'Passed',
                },
                {
                  date: '01/04/2026',
                  cat: 'ISO 27001 Encryption',
                  status: 'Passed',
                },
              ].map((row, i) => (
                <tr
                  key={i}
                  className="border-b border-ds-border/5 last:border-none hover:bg-ds-background-neutral-subtle/5 transition-colors"
                >
                  ...
                  <td className="p-4">
                    <Badge
                      variant="outline"
                      className="text-[9px] font-black uppercase text-ds-text-success border-ds-border-success/30 bg-ds-background-success-subtle/10"
                    >
                      {row.status}
                    </Badge>
                  </td>
