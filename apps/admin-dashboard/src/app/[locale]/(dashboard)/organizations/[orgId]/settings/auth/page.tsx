...
import { Card, CardContent, CardHeader, CardTitle, cn } from '@gate-access/ui';
...
export default async function AuthSettingsPage(props: {
  ...
  const items = [
    { label: 'NEXTAUTH_SECRET', value: envMasked('NEXTAUTH_SECRET'), ok: !!process.env.NEXTAUTH_SECRET },
    { label: 'NEXTAUTH_URL', value: process.env.NEXTAUTH_URL || 'not-set', ok: !!process.env.NEXTAUTH_URL },
    { label: 'ADMIN_ACCESS_KEY', value: envMasked('ADMIN_ACCESS_KEY'), ok: !!process.env.ADMIN_ACCESS_KEY },
