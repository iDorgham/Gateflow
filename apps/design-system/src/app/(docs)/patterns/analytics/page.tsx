...
const analyticsPrinciples = [
  {
    ...
    description:
      'We use a 5-color palette for data visualization. Color 1 is always the active Accent Profile (Kimchi/Cobalt/Emerald).',
    icon: Palette,
  },
  {
    title: 'Perceptual Uniformity',
    description:
      'All chart colors are calibrated to consistent OKLCH lightness levels to ensure accessibility and readability in dark mode.',
    icon: ShieldCheck,
  },
  {
    title: 'Responsive Adaptation',
    description:
      'Charts use CSS variables exclusively. When a profile or theme changes, the entire analytics suite updates instantly.',
    icon: RefreshCcw,
  },
];
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm font-bold text-[var(--ds-text-subtle)] opacity-60">
            Observe how chart colors synchronize with the global
            --ds-primary-accent.
          </p>
        </div>
        <ChartLab />
        ...
        <div className="flex gap-4 relative z-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-[var(--ds-text-subtle)] leading-relaxed max-w-2xl font-medium">
              We do not hardcode colors in charts. By mapping Recharts
              components to institutional tokens like{' '}
              <strong>--gf-color-info</strong> and{' '}
              <strong>--ds-primary-accent</strong>, we ensure that every
              dashboard in the monorepo adheres to the same institutional rigor.
            </p>
          </div>
        </div>
      </section>
