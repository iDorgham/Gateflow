  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
        {[
          { label: 'View QR Codes', href: '/dashboard/qrcodes', icon: QrCode },
          { label: 'Scan Logs', href: '/dashboard/scans', icon: ScanLine },
          { label: 'Manage Gates', href: '/dashboard/gates', icon: Shield },
        ...
        <CardContent className="pt-0">
          {recentScans.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-10 text-center">
              ...
              <p className="text-sm font-medium text-slate-600 dark:text-slate-400">No scans yet</p>
              <p className="mt-1 text-xs text-slate-400">
                Create and share a QR code to see access activity here.
              </p>
              <Button variant="outline" size="sm" asChild className="mt-4">
                <Link href="/dashboard/qrcodes/create">Create your first QR code</Link>
              </Button>
            </div>
          ) : (
