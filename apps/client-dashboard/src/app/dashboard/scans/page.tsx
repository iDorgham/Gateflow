        ...
        <CardContent className="p-0">
          {scans.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-base font-medium text-slate-600 dark:text-slate-300">No scans found</p>
              <p className="mt-1 text-sm text-slate-400">
                {total === 0 && totalUnfiltered > 0
                  ? 'Try adjusting or clearing your filters.'
                  : 'Scans will appear here once access QR codes are used.'}
              </p>
            </div>
          ) : (
              ...
              <table className="w-full text-sm" role="table" aria-label="Scan logs">
                <thead className="border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                  <tr className="text-left text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                    ...
                    <th className="px-4 py-3" scope="col">QR Code</th>
                    {showProjectColumn && (
                    ...
                    <th className="px-4 py-3" scope="col">Operator</th>
                    <th className="px-4 py-3" scope="col">Device</th>
                    <th className="px-4 py-3" scope="col">
                      <a
                        href={sortUrl('status')}
                        className="inline-flex items-center hover:text-slate-800"
