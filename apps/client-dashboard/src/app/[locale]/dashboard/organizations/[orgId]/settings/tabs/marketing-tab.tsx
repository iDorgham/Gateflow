...
export function MarketingTab({ org }: { org: OrgData }) {
  ...
  function handleSave() {
    startTransition(async () => {
      ...
      if (res.success) {
        toast.success(t('settings.marketing.success.saved', 'Marketing attribution parameters updated.'));
      } else {
        ...
        <div className="lg:col-span-12">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-border/50 mb-6">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">Bridge digital marketing campaigns with physical gate arrival events.</p>
                </div>
        ...
        <div className="lg:col-span-7 space-y-8">
          <Card className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
            <CardHeader className="pb-4 pt-6 px-8 border-b border-border/50 bg-muted/5">
                ...
                <CardDescription className="text-xs">Configure tracking scripts to fire on visitor landing pages.</CardDescription>
            </CardHeader>
            <CardContent className="p-8 space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-3">
                        <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60">Meta Pixel ID</Label>
                        <Input 
                            value={pixelMetaId} 
                        ...
                        />
                        <p className="text-[10px] text-muted-foreground">Fires a &apos;PageView&apos; event on visitor landing pages.</p>
                    </div>
                    <div className="space-y-3">
                        <Label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60">Google Tag Manager ID</Label>
                        <Input 
                            value={pixelGtmId} 
                            ...
                            className="h-11 rounded-xl border-border/50 bg-background/50 focus:ring-primary/20 font-bold" 
                        />
                        <p className="text-[10px] text-muted-foreground">Injects GTM container for flexible event tracking.</p>
                    </div>
                </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8">
                <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 py-8">
                    <div className="flex flex-col items-center gap-3 text-center z-10 w-full md:w-1/4">
                        ...
                        <div className="space-y-1">
                            <p className="text-xs font-black uppercase tracking-tight">Ad Click</p>
                            <p className="text-[10px] text-muted-foreground font-medium">Digital Intent</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-3 text-center z-10 w-full md:w-1/4">
                        ...
                        <div className="space-y-1">
                            <p className="text-xs font-black uppercase tracking-tight">QR Generated</p>
                            <p className="text-[10px] text-muted-foreground font-medium">Session Sync</p>
                        </div>
                        <Badge variant="outline" className="text-[8px] font-black tracking-widest border-primary/20 text-primary uppercase bg-primary/5">UTM Captured</Badge>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-3 text-center z-10 w-full md:w-1/4">
                        ...
                        <div className="space-y-1">
                            <p className="text-xs font-black uppercase tracking-tight text-success">Arrival</p>
                            <p className="text-[10px] text-muted-foreground font-medium">Physical Event</p>
                        </div>
                        <Badge className="bg-success text-white text-[8px] font-black tracking-widest uppercase">Verified ROI</Badge>
                    </div>
        ...
        <div className="lg:col-span-5 space-y-6">
            <div className="p-8 rounded-2xl border border-primary/20 bg-primary/5 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                        <p className="text-sm font-black uppercase tracking-tight text-primary">Conversion Logic</p>
                        <p className="text-[10px] font-bold text-primary/60 uppercase tracking-widest">How it works</p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    <div className="flex gap-3">
                        ...
                        <p className="text-xs leading-relaxed text-primary/80 font-medium lowercase first-letter:uppercase">
                            When pixel IDs are set, GateFlow automatically injects the official tracking scripts into every <strong>visitor landing page</strong> for this workspace.
                        </p>
                    </div>
                    <div className="flex gap-3">
                        <div className="mt-1 h-1.5 w-1.5 rounded-full bg-primary shrink-0" />
                        <p className="text-xs leading-relaxed text-primary/80 font-medium lowercase first-letter:uppercase">
                            UTM parameters are synchronized between the guest&apos;s browser session and their physical QR record.
                        </p>
                    </div>
                    <div className="flex gap-3">
                        <div className="mt-1 h-1.5 w-1.5 rounded-full bg-primary shrink-0" />
                        <p className="text-xs leading-relaxed text-primary/80 font-medium lowercase first-letter:uppercase">
                            Reporting on &quot;Cost per Arrival&quot; and Campaign Performance will be available in the <strong>Analytics Hub</strong>.
                        </p>
                    </div>
                </div>

                <Button variant="ghost" className="w-full text-primary hover:bg-white/50 text-[10px] font-black uppercase tracking-widest border border-primary/10 bg-white/30">
            ...
            <Card className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
                <CardHeader className="p-6 pb-4 border-b border-border/50 bg-muted/5 font-black uppercase tracking-widest">
                    <CardTitle className="text-[10px] font-bold text-muted-foreground/60">Ecosystem Status</CardTitle>
                </CardHeader>
                <CardContent className="p-6 space-y-4">
                    ...
                    <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-widest">
                        <span className="text-muted-foreground/60">UTM Session Sync</span>
                        <span className="text-success flex items-center gap-1.5">
                            <div className="h-1.5 w-1.5 rounded-full bg-success animate-pulse" />
                            Active
                        </span>
