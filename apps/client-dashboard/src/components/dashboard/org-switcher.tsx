...
export function OrgSwitcher({ 
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[var(--ds-background-neutral)] shadow-sm">
            {currentOrg.logoUrl ? (
              <img src={currentOrg.logoUrl} alt={currentOrg.name} className="h-6 w-6 object-contain" />
            ) : (
      ...
      <DropdownMenuContent align="start" sideOffset={8} className="w-64 p-2 bg-sidebar/95 backdrop-blur-lg border-border/40">
