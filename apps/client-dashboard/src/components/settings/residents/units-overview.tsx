  ...
  return (
    <div className="space-y-4">
      <div className="relative max-w-sm">
        ...
        <Input
          placeholder={t(
            'settings.residents.searchUnits',
            'Search units or buildings...'
          )}
          ...
          <TableHeader>
            <TableRow className="bg-muted/50 border-b border-border/50">
              <TableHead className="font-bold text-[10px] uppercase tracking-[0.2em]">
                {t('settings.residents.unit', 'Unit')}
              </TableHead>
              <TableHead className="font-bold text-[10px] uppercase tracking-[0.2em]">
                {t('settings.residents.type', 'Type')}
              </TableHead>
              <TableHead className="font-bold text-[10px] uppercase tracking-[0.2em]">
                {t('settings.residents.building', 'Building')}
              </TableHead>
              <TableHead className="font-bold text-[10px] uppercase tracking-[0.2em]">
                {t('settings.residents.quotaUsage', 'Quota Usage')}
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {filteredUnits.length === 0 ? (
              <TableRow>
                ...
                >
                  {t(
                    'settings.residents.noUnits',
                    'No units matching your search.'
                  )}
                </TableCell>
              </TableRow>
            ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className="font-bold tracking-tight uppercase text-[9px] border-border/50"
                      >
                        {unit.type}
                      </Badge>
                    </TableCell>
