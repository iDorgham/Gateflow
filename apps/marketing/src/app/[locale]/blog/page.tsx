        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-12">
          {posts.map((post: any) => (
            <Link
              ...
              className="group"
            >
              <article className="h-full flex flex-col gap-6 bg-white border border-border/30 rounded-3xl p-8 hover:border-primary/50 transition-colors shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500">
