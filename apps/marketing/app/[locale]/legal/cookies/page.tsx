  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>{t('cookies.s2.l1_strong')}</strong>
            {t('cookies.s2.l1_text')}
          </li>
          <li>
            <strong>{t('cookies.s2.l2_strong')}</strong>
            {t('cookies.s2.l2_text')}
          </li>
          <li>
            <strong>{t('cookies.s2.l3_strong')}</strong>
            {t('cookies.s2.l3_text')}
          </li>
        </ul>
      </section>
