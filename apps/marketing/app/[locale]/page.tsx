      ...
      <section className="py-24 bg-muted/20">
        <div className="container px-6 mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-primary mb-4">{t('problems.title')}</h2>
         ...
         <div className="container px-6 mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
               ...
               <div className="bg-card dark:bg-card/50 backdrop-blur border rounded-3xl p-8 lg:p-12 shadow-2xl group hover:border-primary/50 transition-colors">
                  <div className="text-primary mb-6"><Zap className="w-12 h-12" /></div>
                  <h3 className="text-2xl font-bold mb-4">{t('cta.subHeadline')}</h3>
