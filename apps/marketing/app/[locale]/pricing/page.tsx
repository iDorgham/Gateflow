...
export async function generateMetadata(props: {
  ...
  return {
    ...
    description:
      'Compare GateFlow plans and find the perfect access control solution for your needs.',
  };
}
...
const PLANS = (t: any) => [
  {
    ...
    notIncluded: t('tiers.starter.notIncluded', {
      returnObjects: true,
    }) as string[],
    featured: false,
  ...
  },
  {
    ...
    notIncluded: t('tiers.pro.notIncluded', {
      returnObjects: true,
    }) as string[],
    featured: true,
  ...
  },
  {
    ...
    notIncluded: t('tiers.enterprise.notIncluded', {
      returnObjects: true,
    }) as string[],
    featured: false,
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. The Starter plan is permanently free — not a trial. It supports 1 gate and up to 500 scans per month with no credit card required.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Upgrades take effect immediately. Downgrades take effect at the end of the current billing cycle.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "On Starter (500 scans/month), scanning continues but you'll see a warning in the dashboard. We don't hard-block access — but you'll be prompted to upgrade. Pro and Enterprise have no scan limits.",
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes — annual plans include a 17% discount compared to monthly billing. Contact us to switch to annual.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. Monthly plans can be cancelled at any time. Enterprise contracts are available for organizations that need SLAs and custom terms.',
      },
    },
  ],
};
    ...
    <div className="flex flex-col w-full pb-24">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(PRICING_FAQ_JSON_LD),
        }}
      />
      {/* Header */}
      <section className="pt-20 pb-16 text-center container px-6">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm font-medium">
          <span className="flex items-center gap-1.5">
            <Check className="text-success h-4 w-4" /> {t('ui.currencyInfo')}
          </span>
          <span className="flex items-center gap-1.5">
            <Check className="text-success h-4 w-4" /> {t('ui.fawryAccepted')}
          </span>
          <span className="flex items-center gap-1.5">
            <Check className="text-success h-4 w-4" /> {t('ui.cancelAnytime')}
          </span>
        </div>
      </section>
          ...
          >
            ...
            <Button
              ...
              className={cn(
                ...
                plan.featured ? 'bg-white text-black hover:bg-slate-100' : ''
              )}
              asChild
            >
      ...
      <section className="bg-muted/30 py-24 border-y">
        <div className="container px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <Feature
              icon={<Shield />}
              title={t('comparisonMini.features.signedQr.title')}
              desc={t('comparisonMini.features.signedQr.description')}
            />
            <Feature
              icon={<Smartphone />}
              title={t('comparisonMini.features.offlineFirst.title')}
              desc={t('comparisonMini.features.offlineFirst.description')}
            />
            <Feature
              icon={<BarChart3 />}
              title={t('comparisonMini.features.liveAnalytics.title')}
              desc={t('comparisonMini.features.liveAnalytics.description')}
            />
            <Feature
              icon={<Building2 />}
              title={t('comparisonMini.features.multiGate.title')}
              desc={t('comparisonMini.features.multiGate.description')}
            />
            <Feature
              icon={<Zap />}
              title={t('comparisonMini.features.webhookSync.title')}
              desc={t('comparisonMini.features.webhookSync.description')}
            />
            <Feature
              icon={<Globe />}
              title={t('comparisonMini.features.arabicSupport.title')}
              desc={t('comparisonMini.features.arabicSupport.description')}
            />
          </div>
        </div>
      </section>
